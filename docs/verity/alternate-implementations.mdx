...
<div className="zoom">
	...
	Blockchains](https://usher-pub.s3.us-east-1.amazonaws.com/docs/Verity+Architecture+for+Sovereign+Blockchains.jpeg)
</div>
...
<div className="zoom">
	...
	Analysis](https://usher-pub.s3.us-east-1.amazonaws.com/docs/Verity+Architecture+for+Analysis.jpeg)
</div>
