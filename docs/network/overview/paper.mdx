...
- [Data Protocols Lightpaper](https://go.usher.so/lightpaper)
- [Technical Specification](https://go.usher.so/tech-spec)
...
[Learn about Client Side Network Verification →](../sdk/client-side-network-verification.md)

### A Guide on the Query Process and Network Verification

<LoomVideo
	src={`https://www.loom.com/share/a21d5fb105a64258b25c9106391997e9?sid=7c5f291c-e42e-4b81-8dc2-2a4e23bd38af`}
	hideOwner
/>
